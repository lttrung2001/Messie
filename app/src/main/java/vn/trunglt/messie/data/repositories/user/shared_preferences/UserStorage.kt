...
class UserStorage(
    ...
    companion object {
        ...
        private val ANIMAL_NAMES = listOf(
            "Aardvark", "Albatross", "Alligator", "Alpaca", "Attack Cat",
            ...
            "Crab", "Crocodile", "Crow", "Curlew", "Deer",
            "Dinosaur", "Dog", "Dodo", "Dolphin", "Donkey",
            ...
            "Frog", "Fowl", "Gazelle", "Gerbil", "Giraffe",
            "Gnat", "Goat", "Goose", "Goldfinch", "Gorilla",
            "Goshawk", "Grasshopper", "Grouse", "Guanaco", "Gull",
            ...
            "Marten", "Meerkat", "Mink", "Mole", "Mongoose",
            ...
            "Pony", "Porcupine", "Porpoise", "Quail", "Quelea",
            "Quetzal", "Rabbit", "Raccoon", "Rail", "Ram",
            "Rat", "Raven", "Red deer", "Red panda", "Reindeer",
            "Rhinoceros", "Rook", "Salamander", "Salmon", "Sandpiper",
            "Sardine", "Scorpion", "Sea lion", "Sea urchin", "Seal",
            "Shark", "Sheep", "Shrew", "Skunk", "Snail",
            "Snake", "Sparrow", "Spider", "Spoonbill", "Squid",
            "Squirrel", "Starling", "Stingray", "Stinkbug", "Stork",
